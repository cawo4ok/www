...
//Meny
                             $leftMenu = array(
                                 ...
                                 array('link'=>'Таблиця множення', 'href'=>'table.php'),
                                 array('link'=>'Калькулятор', 'href'=>'calc.php'));
//*************************************************************
    $hour = (int)strftime('%H');
    $welcome = ''; // Ініціалізуємо зміння для привітання
    if ($hour<6 && $hour>0) $welcome= 'Доброї ночі';
    elseif ($hour<12 && $hour>=6) $welcome= 'Добрий ранок';
    elseif ($hour<18 && $hour>=12) $welcome= 'Добрий день';
    elseif ($hour<23 && $hour>=18) $welcome= 'Добрий вечір';
else 
    $welcome='Доброї ночі';
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" lang="ru">
	...
	<body>
		...
		<div id="content">
			<!-- Заголовок -->
			<h1><? echo $welcome ?>, Шанувальнику!</h1>
			<!-- Заголовок -->
			<!-- Область основного контента -->
                        <blockquote>
                            <?php
                            echo "Сьогодні $day число,$mon місяць, $year рік.";
                            ?>
                        </blockquote>
